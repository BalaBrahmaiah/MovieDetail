...
class ViewController: UIViewController,UIPageViewControllerDataSource,UIScrollViewDelegate {
    ...
    func loadMovieDetailsData(){
        ...
        let movie5 = MovieModel(title: "Pirates of the Caribbean" , url: "http://www.latestlivemovies.com/wp-content/uploads/cache/4370_NpAdvSinglePhoto.jpg", description: "Pirates of the Caribbean is a series of fantasy swashbuckler films produced by Jerry Bruckheimer and based on Walt Disney's theme park ride of the same name.", rating: "4/5", language: "English", characters: "Jack Sparrow, Davy Jones", directors: "Gore Verbinski, Rob Marshall")
        ...
        self.movieDetails.append(movie5!)
    }
}
